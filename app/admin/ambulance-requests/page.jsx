...
export default function AmbulanceRequestsPage() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    refetchInterval: 20000, queryKey: ["ambulance-requests", filter, page], queryFn: async () => (await api.get("/ambulance-requests", { params: { page, limit: 12, status: filter === "all" ? undefined : filter } })).data });
